...
<div class="relative min-h-screen flex items-center justify-center bg-black overflow-hidden pt-16">
  ...
  <div class="relative z-10 flex flex-col items-center text-center px-4">
    <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-6">
      <span class="text-red-500"> Drone Pilot</span>
      <span class="text-white">, IT Specialist,</span>
      <span class="text-red-500"> Tech Innovator</span>
    </h1>
    <p class="text-lg md:text-2xl text-white/80 mb-8 max-w-2xl">
